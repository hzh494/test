window.onload = function () {
    ...
    // tab栏切换
    (function () {
    var uls = document.querySelector('.tab_title ul');
    var VMall_bots = document.querySelector('.VMall_bots');
    var VMall_top = document.querySelector('.VMall_top');
    for (var i = 0; i < uls.children.length; i++) {
        uls.children[i].index = i;
        uls.children[i].onmouseenter = function () {
            this.style.borderBottom = '1px solid blue';
            VMall_top.style.borderBottom = '1px solid #ccc';
            VMall_bots.children[this.index].style.display = 'block';
            
        }
        uls.children[i].onmouseleave = function () {
            this.style.borderBottom = 'none';
            VMall_bots.children[this.index].style.display = 'none';
            VMall_top.style.borderBottom = 'none';
            VMall_bots.children[this.index].onmouseenter = function() {
